defmodule OpenGraphExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(OpenGraphExampleWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(OpenGraphExampleWeb.Gettext, "errors", msg, opts)
    # end
